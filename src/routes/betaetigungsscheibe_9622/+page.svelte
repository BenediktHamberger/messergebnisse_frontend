<script lang="ts">
	...
	const title = 'Betätigungsscheibe 9622 Messwerte';

	const columns = siteColumns['messwerte_bts_9622'];
...
<ResultsPage {title} {columns} query_url={'query_betaetigungsscheibe_9622'} {filters} />
